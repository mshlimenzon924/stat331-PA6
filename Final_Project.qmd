...
$$emissions = 0.505 + 0.278average.income$$
Where $emissions$ is the emissions per capita of a country, measured in millions of tonnes of CO2, and $average.income$ is the average income per capita in constant international dollars.
...
Interpretation of $average.income$: Each increase in one constant international dollar of income per capita is associated with an increase of .278 million tonnes in CO2 emissions per capita for all countries similar to those in the study.
