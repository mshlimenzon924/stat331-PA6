...
# We need it to be read, only paragraphs, no acronyms, 
...
Interpretation of $a$: Each increase in one constant international dollar of income per capita is associated with an increase of .278 million tonnes in CO2 emissions per capita for all countries similar to those in the study.
