...
#Regression Equation 
$$Emissions = 0.505 + 0.278averageIncome $$
...
Interpretation of average_income_per_capita: Each increase in one constant international dollar is associated with an increase of .278 million tonnes in CO2 emissions per capita for all countries similar to those in the study.
...
75.73% of the variation in average CO2 emissions is explained by the linear regression model, using average income per capita as the predictor variable.