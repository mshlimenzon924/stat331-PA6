...
# ADD CITATION - we need to have both in-line citations/ paranthesis and a reference section in 
# Data Sources need to be cited and description of variables 
...
merged_data %>%
  ...
  labs(x = "Year", y = "",
       ...
       subtitle = "Average Income Per Capita (PPP)") +
...
$$e = 0.505 + 0.278a$$
Where $e$ is the emissions per capita of a country, measured in millions of tonnes of CO2, and $a$ is the average income per capita in constant international dollars.
...
Interpretation of $a$: Each increase in one constant international dollar is associated with an increase of .278 million tonnes in CO2 emissions per capita for all countries similar to those in the study.
...
cor(merged_data, [, c("emissions", "average_income")])
```
